...
const DotField = memo(({
  ...
  sparkle = false,
  waveAmplitude = 0,
  gradientFrom = 'rgba(201, 169, 98, 0.35)',
  gradientTo = 'rgba(138, 133, 120, 0.25)',
  glowColor = '#1a1a1a',
  className = '',
  style,
}: DotFieldProps) => {
  ...
  return (
    <div className={`dot-field-container ${className}`} style={{ position: 'relative', width: '100%', height: '100%', ...style }}>
      <canvas
        ref={canvasRef}
        style={{
          position: 'absolute',
